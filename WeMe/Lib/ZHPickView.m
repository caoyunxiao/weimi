...
{
    BOOL _isHaveNavi; // 判断是否有navi 来显示不同的阴影
}
...
-(instancetype)initPickviewWithArray:(NSArray *)array isHaveNavControler:(BOOL)isHaveNavControler{
    ...
    if (self) {
        ...
        [self setUpPickView];
        [self setFrameWith:isHaveNavControler];
        _isHaveNavi = isHaveNavControler;
    }
...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    if (_defaulDate)
    {
        ...
        NSDate * maxDate = [_defaulDate dateByAddingTimeInterval:2*24*60*60];
...
-(void)remove{
    ...
    [[[UIApplication sharedApplication].keyWindow viewWithTag:77] removeFromSuperview];
...
-(void)show
{
    ...
    if (_isHaveNavi)
    {
        ...
        UIView * view2 = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width,[UIScreen mainScreen].bounds.size.height - self.frame.size.height-ZHToobarHeight-10)];
        view2.backgroundColor = [UIColor grayColor];
        view2.alpha = 0.5;
        [[UIApplication sharedApplication].keyWindow addSubview:view2];
        view2.tag = 77;
        view2.userInteractionEnabled = YES;
        [view2 addGestureRecognizer:[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tapAction)]];
    ...
    else
    {
        ...
        UIView * view2 = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width,[UIScreen mainScreen].bounds.size.height - self.frame.size.height-ZHToobarHeight-10 + 50)];
        view2.backgroundColor = [UIColor grayColor];
        view2.alpha = 0.5;
        [[UIApplication sharedApplication].keyWindow addSubview:view2];
        view2.tag = 77;
