...
+ (CFSharer *)sina
{
    return [[CFSharer alloc] initWithName:@"新浪微博" imageName:@"sns_icon_1.png"];
}
+ (CFSharer *)wxFriend
{
    return [[CFSharer alloc] initWithName:@"微信好友" imageName:@"sns_icon_22.png"];
}
+ (CFSharer *)wxCircle
{
    return [[CFSharer alloc] initWithName:@"微信朋友圈" imageName:@"sns_icon_23.png"];
}
