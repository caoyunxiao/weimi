...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self)
    {
        _sharers = [[NSMutableArray alloc] initWithObjects: [CFSharer sina], [CFSharer wxFriend], [CFSharer wxCircle], nil];
        //, [CFSharer facebook], [CFSharer evernote], [CFSharer dropbox], [CFSharer mail], [CFSharer photoLibrary]
